define("xg/jx-business/1.0.0/p/commodity/myUpload-debug", ["xg/jx-business/1.0.0/c/js/base/zepto-debug", "xg/jx-business/1.0.0/c/js/base/sm-debug", "xg/jx-business/1.0.0/c/js/base/zepto-debug.touch", "xg/jx-business/1.0.0/c/js/base/zepto-debug.deferred", "xg/jx-business/1.0.0/c/js/base/zepto-debug.callbacks", "xg/jx-business/1.0.0/c/js/base/swiper-debug", "xg/jx-business/1.0.0/p/commodity/producttype-debug.handlebars", "xg/jx-business/1.0.0/p/commodity/additem-debug.handlebars", "xg/jx-business/1.0.0/c/js/tools-debug"], function(require, exports, module) {
    require("xg/jx-business/1.0.0/c/js/base/zepto-debug");
    ...
    var Swiper = require("xg/jx-business/1.0.0/c/js/base/swiper-debug");
    var listtype = require("xg/jx-business/1.0.0/p/commodity/producttype-debug.handlebars");
    var tmpform = require("xg/jx-business/1.0.0/p/commodity/additem-debug.handlebars");
                    ...
                    fr.onloadend = function(event) {
                        if (event.target.result) {
                            ...
                            imgss.onload = function() {
                                ...
                                $("#upimgpre").append("<div class='preup swiper-slide'><img data-numpic='" + numpic + "' src='" + Pic + "'></div>");
                                $("#myCanvas").remove();
                                numpic++;
                                $(e.target).removeClass("imgget");
                                $("#new-form").append("<input accept='image/*' type='file' class='imgget' data-numpic='" + numpic + "'>");
                                self.picturnPrelook();
                                if ($(".preup").length > 0) {
                        ...
                        for (var j = 0; j < $(".rightmore").length; j++) {
                            ...
                            if (nowGetname && nowGetOnePrice && nowGetTwoPrice && nowGetThreePrice) {
                                if (Reg.test(nowGetOnePrice) && Reg.test(nowGetTwoPrice) && Reg.test(nowGetThreePrice)) {
                                    prespecStr.specStr.push({
                                        spec: nowGetname,
                                        primePrice: nowGetOnePrice,
                                        currentPrice: nowGetTwoPrice,
                                        backPrice: nowGetThreePrice
                                    })
                                } else {
