define("xg/jx-business/1.0.0/p/orderManagement/testRefresh-debug", ["xg/jx-business/1.0.0/c/js/base/zepto-debug", "xg/jx-business/1.0.0/c/js/base/sm-debug", "xg/jx-business/1.0.0/c/js/base/sm-extend-debug"], function(require, exports, module) {
    ...
    $(document).on("refresh", ".pull-to-refresh-content", function(e) {
        ...
        setTimeout(function() {
            ...
            var cardHTML = '<div class="card">' + '<div class="card-header">card' + cardNumber + "</div>" + '<div class="card-content">' + '<div class="card-content-inner">' + "这里是第" + cardNumber + "个card，下拉刷新会出现第" + (cardNumber + 1) + "个card。" + "</div>" + "</div>" + "</div>";
