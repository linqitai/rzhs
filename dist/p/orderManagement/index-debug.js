define("xg/jx-business/1.0.0/p/orderManagement/index-debug", ["xg/jx-business/1.0.0/c/js/base/zepto-debug", "xg/jx-business/1.0.0/c/js/base/dragloader-debug", "xg/jx-business/1.0.0/c/js/base/zepto-debug.touch", "xg/jx-business/1.0.0/c/js/base/zepto-debug.deferred", "xg/jx-business/1.0.0/c/js/base/zepto-debug.callbacks", "xg/jx-business/1.0.0/c/js/base/sm-debug", "xg/jx-business/1.0.0/c/js/base/sm-extend-debug", "xg/jx-business/1.0.0/c/js/fastclick-debug", "xg/jx-business/1.0.0/c/js/registerHelper-debug", "alinw/handlebars/1.3.0/runtime-debug", "xg/jx-business/1.0.0/p/orderManagement/allOrder-debug.handlebars", "xg/jx-business/1.0.0/p/orderManagement/ordered-debug.handlebars", "xg/jx-business/1.0.0/p/orderManagement/discuss-debug.handlebars", "xg/jx-business/1.0.0/p/orderManagement/notData-debug.handlebars"], function(require, exports, module) {
    var $ = require("xg/jx-business/1.0.0/c/js/base/zepto-debug");
    require("xg/jx-business/1.0.0/c/js/base/dragloader-debug");
    ...
    var allOrderTemp = require("xg/jx-business/1.0.0/p/orderManagement/allOrder-debug.handlebars");
    var orderedTemp = require("xg/jx-business/1.0.0/p/orderManagement/ordered-debug.handlebars");
    var discussTemp = require("xg/jx-business/1.0.0/p/orderManagement/discuss-debug.handlebars");
    var notData = require("xg/jx-business/1.0.0/p/orderManagement/notData-debug.handlebars");
    module.exports = {
        init: function() {
            $.showIndicator();
            var self = this;
        ...
        initEvents: function() {
            ...
            $(document).on("click", "#allOrder .create-discuss-popup", function(e) {
                ...
                var popupHTML = '<div class="popup popup-discuss">                                    <div class="content-block">                                        <div class="jx-pop-title">                                            <i class="icon icon-closepop close-popup"></i>                                        </div>                                        <textarea class="discussContent" placeholder="请输入评论内容......"></textarea>                                        <footer class="orange-btn open-about" id="sureDiscussBtn">提交评价</footer>                                    </div>                                </div>';
                $.popup(popupHTML)
            });
...
define("xg/jx-business/1.0.0/c/js/base/dragloader-debug", [], function(require, exports, module) {
    (function(window) {
        ...
        DragLoader.prototype = {
            ...
            _translate: function() {
                var me = this,
                    ...
                    orient, target, targetHeight, adjustHeight, maxDuration = 200,
                    duration, upperStr, threshold, endFn = function() {
...
define("xg/jx-business/1.0.0/p/orderManagement/ordered-debug.handlebars", ["alinw/handlebars/1.3.0/runtime-debug"], function(require, exports, module) {
    var Handlebars = require("alinw/handlebars/1.3.0/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [4, ">= 1.0.0"];
        ...
        function program1(depth0, data) {
            ...
            buffer += escapeExpression(stack1) + '</div>\r\n                        <!--<div class="replace">使用代金券<span class="voucher">';
            if (helper = helpers.discount) {
                stack1 = helper.call(depth0, {
                    hash: {},
                    data: data
...
define("xg/jx-business/1.0.0/p/orderManagement/discuss-debug.handlebars", ["alinw/handlebars/1.3.0/runtime-debug"], function(require, exports, module) {
    var Handlebars = require("alinw/handlebars/1.3.0/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [4, ">= 1.0.0"];
        ...
        function program1(depth0, data) {
            ...
            buffer += escapeExpression(stack1) + '</span>元</div>\r\n                    </div>\r\n                </a>\r\n                <div class="btnGroup">\r\n                    <button class="btn btn-default right not-fill discussBtn" data-id="';
            if (helper = helpers.id) {
                stack1 = helper.call(depth0, {
                    hash: {},
                    data: data
...
define("xg/jx-business/1.0.0/p/orderManagement/notData-debug.handlebars", ["alinw/handlebars/1.3.0/runtime-debug"], function(require, exports, module) {
    var Handlebars = require("alinw/handlebars/1.3.0/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [4, ">= 1.0.0"];
