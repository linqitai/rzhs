define("xg/jx-business/1.0.0/p/goodDetails/goodsDetails-debug", ["xg/jx-business/1.0.0/c/js/base/zepto-debug", "xg/jx-business/1.0.0/c/js/base/sm-debug", "xg/jx-business/1.0.0/c/js/base/zepto-debug.touch", "xg/jx-business/1.0.0/c/js/base/zepto-debug.deferred", "xg/jx-business/1.0.0/c/js/base/zepto-debug.callbacks", "xg/jx-business/1.0.0/c/js/fastclick-debug", "xg/jx-business/1.0.0/c/js/tools-debug"], function(require, exports, module) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.result == "ok") {
                        ...
                        var str = "",
                            typeStr = "",
                            lens = data.data.picPath.length,
                            specLens = data.data.productSpecList.length;
