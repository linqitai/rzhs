define("xg/jx-business/1.0.0/c/js/moment-debug", [], function(require, exports, module) {
    (function(global, factory) {
        ...
        function be__weekdaysCaseReplace(m, format) {
            var weekdays = {
                ...
                nounCase = /\[ ?[Ð’Ð²] ?(?:Ð¼Ñ–Ð½ÑƒÐ»ÑƒÑŽ|Ð½Ð°ÑÑ‚ÑƒÐ¿Ð½ÑƒÑŽ)? ?\] ?dddd/.test(format) ? "accusative" : "nominative";
        ...
        function ru__weekdaysCaseReplace(m, format) {
            var weekdays = {
                ...
                nounCase = /\[ ?[Ð’Ð²] ?(?:Ð¿Ñ€Ð¾ÑˆÐ»ÑƒÑŽ|ÑÐ»ÐµÐ´ÑƒÑŽÑ‰ÑƒÑŽ|ÑÑ‚Ñƒ)? ?\] ?dddd/.test(format) ? "accusative" : "nominative";
            return weekdays[nounCase][m.day()]
        }
