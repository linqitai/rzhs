define("xg/jx-business/1.0.0/c/js/drawProcess-debug", ["xg/jx-business/1.0.0/c/js/base/zepto-debug"], function(require, exports, module) {
    ...
    DrawProcess.prototype = {
        ...
        initAttr: function(dom, x, y, radius, process, backColor, proColor, fontColor) {
            ...
            if (process != 0 && process != 100) {
                cts.beginPath();
                cts.moveTo(x, y);
                cts.arc(x, y, radius, Math.PI * 1.5, Math.PI * 2 * process / 100 - Math.PI * .5, false);
                cts.closePath();
            ...
            cts.beginPath();
            cts.moveTo(x, y);
            cts.arc(x, y, radius - radius * .1, 0, Math.PI * 2, false);
            cts.closePath();
