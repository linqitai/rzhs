(function(factory) {
    if (typeof define === "function" && define.amd) {
        define("xg/jx-business/1.0.0/c/js/mvalidate-debug", ["xg/jx-business/1.0.0/c/js/base/zepto-debug"], function($) {
            factory($)
        })
    } else if (typeof define === "function" && define.cmd) {
        define("xg/jx-business/1.0.0/c/js/mvalidate-debug", ["xg/jx-business/1.0.0/c/js/base/zepto-debug"], function(require, exports, moudles) {
            factory(require("xg/jx-business/1.0.0/c/js/base/zepto-debug"))
        })
    } else {
        factory($)
    }
    ...
    var validateField = function(event, options) {
        var $field = $(this),
            ...
            log, errorTipFormat = $.fn.mvalidate.errorTipFormat,
        ...
        if ($describedShowElem.length > 0 && options.type == 2) {
            if ((event.type == "keyup" || event.type == "change") && (!$describedShowElem.children().length || !$.trim($describedShowElem.text()))) {} else {
    ...
    $.extend($, {
        ...
        validateField: function(event, opt) {
            var result = validateField.call(this, event, opt),
                valid = false;
            if (result.required && result.conditional && result.pattern) {
                valid = true
            }
            return valid
        }
    ...
    $.fn.mvalidateDestroy = function() {
        var $form = $(this),
            $fields, dataValidate = $form.data(name);
